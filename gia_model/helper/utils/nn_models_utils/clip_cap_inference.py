# -*- coding: utf-8 -*-
# @CreateTime : 2021/12/10 16:48
# @Author     : 潘其威(PanEa)
# @Company    : Gemsouls
# @File       : clip_cap_inference.py
# @Description:
# @LastEditBy :
...
WEIGHTS_PATHS = {
    "coco": "./model/coco_weights.pt",
    "conceptual-captions": "./model/conceptual_weights.pt",
}
...
class Predictor:
    def __init__(self, pretrained_weights: Any):
